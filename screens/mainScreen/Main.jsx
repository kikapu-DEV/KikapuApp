...
const screenOptions = ({route}) =>({
    tabBarIcon: ({focused, color, size})=>{
        ...
        else if (routeName === wallet){iconName = focused? 'wallet': 'wallet-outline'}
        else if (routeName === orders){iconName = focused? 'cart' : 'cart-outline'}
...
function Main() {
  return (
    <Tab.Navigator initialRouteName="Home" screenOptions={screenOptions}>
      ...
      <Tab.Screen name={orders} component={Order} options={{ headerShown: false}}/>
